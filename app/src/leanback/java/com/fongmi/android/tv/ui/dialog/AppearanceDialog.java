...
public final class AppearanceDialog extends DialogFragment implements ThemeDialog.Listener {
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        return LightDialog.create(requireContext(), getString(R.string.setting_settings_language), createContent(), getString(R.string.dialog_close), null, null, null);
    }
    ...
    private void notifyChanged() {
        if (requireActivity() instanceof Listener) ((Listener) requireActivity()).onAppearanceChanged();
    }
